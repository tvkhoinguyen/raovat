<div class="col-xs-12 col-sm-2 col-lg-3 logo">
    <div class="logo-image logo-control">
        <a href="<?php echo Yii::app()->createAbsoluteUrl('site/index'); ?>" title="Rao vặt Thằng Bờm">
        ...
        <small class="site-slogan">Các rao vặt hot nhất và thực tế nhất trong khu vực AZ và USA</small>
    </div>
</div>